# This script was written by Clint Bodungen (@R1ngZer0). You are free to use, copy, and distribute
# it as you wish. Just be so kind as to give me a shout out for the inspiration :-)

# This script integrates the OpenAI GPT API with an OS so that you can use NLP natural language 
# processing to generate and execute simple to very complex commands, without any knowledge of 
# the underlying OS or apps used.
